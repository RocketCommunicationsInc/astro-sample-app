  ...
  static get template() {
    ...
    *:before {
    ...
    <section class="astro-telemetry-pane">
      <h1>[[title]]</h1>
      <rux-spectrum-analyzer chart-legend-x="freq" chart-legend-y="pwr" chart-title="signals" height="384" width="920" x-scale-min="920" x-scale-max="2301" x-scale-step="175" y-scale-min="-30" y-scale-max="0" data-source="wss://egs-data-services.astrouxds.com/satellite1" data-source-type="web-socket"></rux-spectrum-analyzer>
